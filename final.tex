...
Wbrew oczekiwanion algorytm CMA-ES uruchomiony na funkcji stałi ma tendencje do zmniejszania kroku algorytmu, więc po kilkuset iteracjach przemieszczenia się wartości oczekiwanej jest znikome. Obrazują to rysunki w tym podrozdziale. Widać na nich fragmenty, w których punkty były losowane z dużą różnicą, obszar gdzie różnice były małe oraz miejsce, w którym algorytm znalazł się i prawie nie poruszał (czerwony kwadrat)\\
...
\caption{Histogram punktów; algorytm CMA-ES; funkcja losowa; 2 stała}
\end{figure}
